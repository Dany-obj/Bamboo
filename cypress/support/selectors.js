export const SELECTORS = {
    ...
    timeoff: {
        ...
        headerBoxIcon: 'a[data-bi-id="header-inbox"]',
        timeRequestsOption: 'a[data-bi-id="site-manage-nav-inbox-menu-option-time-off-requests"]',
    ...
    registeremployee: {
        ...
        firstnameField:'input[aria-label="First Name"]', 
        lastnameField: 'input[aria-label="Last Name"]',
        saveButton: 'button[data-bi-id="employees-add-employee-form-save"]',
        registerToast: '.jade-Alert__left',
        effectiveDateField: '#field_4021-0',
        departmentField: 'div[aria-label="Department –Select–"]',
        divisionField: 'div[aria-label="Division –Select–"]',
    },
    addjob: {
        ...
        joblocationField: 'label[data-bi-id="job-location-select-remote"]',
        jobdescriptionField: '#description',
    ...
    benefitsTab: {
        benefitCard: 'button[data-bi-id="benefit-plan-card-gear-menu-toggle"]',
        benefitButton: 'div#js-plan-action-dropdown',
        menuitem: 'div[role="menuitem"]',
        datewaivedField: 'input[placeholder="mm/dd/yyyy"]',
        saveButton: 'button[type="submit"][data-fabric-component="Button"]',
